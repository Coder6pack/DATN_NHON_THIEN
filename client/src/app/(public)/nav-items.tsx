    ...
    <div className="flex items-center space-x-6">
      ...
      <div className="relative">
        <input
          ...
          className="w-64 px-4 py-2 pr-10 rounded-full border border-gray-300 focus:outline-none focus:border-blue-500 text-gray-700 placeholder-gray-500 hover:border-gray-400 transition-colors"
        />
            ...
            <div className="p-4">
              <div className="flex justify-between items-center mb-4">
                <span className="text-sm font-semibold text-gray-700">
                  Tạm tính: <span className="text-red-600">{totalAmount.toLocaleString('vi-VN')}đ</span> ({totalItems} sản phẩm)
                </span>
              </div>
